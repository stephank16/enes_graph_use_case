# Adoption from https://github.com/nicolewhite/neo4j-jupyter/find/master
# uses vis js library from Almende: clone https://github.com/almende/vis.git
...
def vis_network(nodes, edges, physics=False):
    ...
    <html>
    <head>
      <script type="text/javascript" src="/home/stephan/Repos/Watching/vis/dist/vis.js"></script>
      <link href="/home/stephan/Repos/Watching/vis/dist/vis.css" rel="stylesheet" type="text/css">
    </head>
    <body>
    <div id="{id}"></div>
    ...
    filename = "/home/stephan/Repos/ENES-EUDAT/enes_graph_use_case/neo4j_prov/notebooks/graph-{}.html".format(unique_id)

    file = open(filename, "w")
    file.write(html)
    file.close()

    print "Javascript visualization generated: ",filename
